"""
https://github.com/aymericdamien/TensorFlow-Examples/blob/master/notebooks/3_NeuralNetworks/neural_network_eager_api.ipynb
"""
...
# Network Parameters
n_hidden_1 = 256    # number of neurons of the 1st layer
...
for step in range(num_steps):
    ...
    if (step + 1) % display_step == 0 or step == 0:
        ...
        print('Step: ', '%04d' % (step+1), ' Loss=', '{:.9f}'.format(average_loss),
