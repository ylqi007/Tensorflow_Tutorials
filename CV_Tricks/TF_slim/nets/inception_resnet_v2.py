...
"""
2019-03-30
https://github.com/sankit1/cv-tricks.com/blob/master/Tensorflow-tutorials/Tensorflow-slim-run-prediction/nets/inception_resnet_v2.py
...
def inception_resnet_v2_arg_scope(weight_decay=0.00004,
    ...
    """
    Yields the scope with the default parameters for inception_restnet_v2.

    :param weight_decay: the weight decay for weights variables.
    :param batch_norm_decay: decay for the moving average of batch_norm momentums.
