...
Usage:
    with slim.arg_scope(inception_arg_scope()):
        logits, end_points = inception.inception_v3(image, num_classes, is_training=is_training)
"""
...
def inception_arg_scope(weight_decay=0.00004,
    ...
    :param batch_norm_epsilon: Small float added to variance to avoid dividing by zero in batch norm.
    ...
    batch_norm_params = {
        ...
        'updates_collections': tf.GraphKeys.UPDATE_OPS,     # collection containing update_ops.
    }
    if use_batch_norm:
        normalizer_fn = slim.batch_norm
        normalizer_param = batch_norm_params
    else:
        normalizer_fn = None
        normalizer_param = {}
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        with slim.arg_scope([slim.conv2d],
                            ...
                            normalizer_param=normalizer_param) as sc:
            return sc
